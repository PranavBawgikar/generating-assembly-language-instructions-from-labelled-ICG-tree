...
print_inorder(tree) {
  if (tree) {
    ...
    // document.writeln(tree.data + " with Label " + tree.label);
...
gencode(tree) {
  ...
  if (tree.left != null && tree.right != null) {
    if (tree.left.label == 1 && tree.right.label == 0 && tree.left.left == null && tree.left.right == null && tree.right.left == null && tree.right.right == null) {
      //console.log(`MOV ${tree.left.data}, R[${R[top]}]`);
      console.log("MOV " + tree.left.data + ",R[" + this.R[this.top] + "]" + "\n");
      // document.writeln("MOV " + tree.left.data + ",R[" + this.R[this.top] + "]"+ "\n");
      ...
      // document.writeln(`${this.op} ${tree.right.data}, R[${this.R[this.top]}]`);
      ...
      // document.writeln(`${this.op} R[${this.R[this.top - 1]}], R[${this.R[this.top]}]`);
    ...
    // document.writeln(`MOV ${tree.data}, R[${this.R[this.top]}]`);
...
function inputfuntion() {
  ...
  console.log("\nAssembly Code:\n");
  // document.writeln("Assembly Code");
